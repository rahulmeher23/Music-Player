...
import { filterSearch, forYou, topTracks } from '../store/slice/songsSlice';
...
const SongsList = () => {
    ...
    const handleChange = (e) => {
        ...
        dispatch(filterSearch(seachQuery))
    }
    return (
        <>
            ...
            <div className='songs-list xl:mt-10 xl:w-[350px]  2xl:w-[432px] p-5 xl:p-0'>
                ...
                <div className='relative search-bar w-full h-12 mb-6'>
                    <input type="text" placeholder='Search Songs, Artist' className='w-full h-full px-4 py-2 rounded-lg bg-[rgba(255,255,255,0.08)] focus:none' onChange={(e) => handleChange(e)} />
